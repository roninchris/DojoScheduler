                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                              ...
                              <AlertDialogDescription>
                                  Esta ação irá cancelar permanentemente a matrícula de <span className='font-bold'>{booking.member.name}</span> na aula <span className='font-bold'>{booking.class.name}</span>.
                              </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                              <AlertDialogCancel>Voltar</AlertDialogCancel>
                              <AlertDialogAction onClick={() => handleDelete(booking)}>
                                  Sim, cancelar
                              </AlertDialogAction>
                              </AlertDialogFooter>
                          </AlertDialogContent>
